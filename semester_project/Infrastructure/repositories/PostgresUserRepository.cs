...
public sealed class PostgresUserRepository : IUserRepository
{
    ...
    public PostgresUserRepository(PostgresConnectionFactory factory)
    ...
    private static User Map(NpgsqlDataReader reader)
    {
        ...
        int ixFGenre = reader.GetOrdinal("favorite_genre");
    ...
    public async Task<bool> UpdateProfileAsync(long id, string? email, string? firstName, string? lastName, Genre? genre)
    {
